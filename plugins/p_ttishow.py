        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://mangandi-2-0.onrender.com/Xdgv.mp4",                                               
                                                 caption=f'<pre>Hey, {u.mention} 👋🏻\nWelcome to {message.chat.title} Chat.</pre>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton(f'Channel​', url='https://t.me/xbots_x') ] ] )
                )
